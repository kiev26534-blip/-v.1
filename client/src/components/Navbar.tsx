  ...
  return (
    ...
    >
      <div className="container flex h-16 items-center px-4 md:px-8">
        <button onClick={() => setLocation("/")} className="mr-6 flex items-center space-x-2 cursor-pointer hover:opacity-80 transition-opacity">
          <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center text-white font-bold text-xs">
            ส.ท.
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              ...
              <Button 
                ...
                className="rounded-full bg-primary hover:bg-primary/90 px-6 shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95"
              >
                เข้าสู่ระบบ
              </Button>
            )}
